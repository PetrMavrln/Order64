...
const OrderSystemThesisBlockComponent = () => {
  const orderSystem = [
    ...
    },
    {
      ...
      text: ' А точнее, колонна. Сравнить всё здание с человеком невозможно, а колонну с человеком - пожалуйста. Колонна выступает как счетно-измерительная сеточка. Для определения идеальных пропорций колонны греки придумали, что надо делать колонны с соотношение ширины и высоты как у человека - от 1 к 5,5 до 1 к 10.',
    },
  ];
